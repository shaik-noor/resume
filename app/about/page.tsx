        ...
        <div className="grid gap-6 p-6 sm:grid-cols-[auto,1fr] sm:items-center">
          ...
          <div className="space-y-3">
            <div className="flex flex-wrap items-center gap-3">
              <h1 className="text-2xl md:text-3xl font-bold">Hi, I&apos;m Shaik Noor Mohammad</h1>
              <Badge variant="secondary" className="text-xs">Support Engineer @ Informatica</Badge>
            </div>
            <p className="text-muted-foreground max-w-prose">
              I specialize in PowerCenter and IDMC product support with a focus on
              technical assistance, troubleshooting, and software issue resolution.
        ...
        <Card>
          <CardContent className="py-4">
            <div className="flex items-baseline justify-between">
              ...
              <Badge variant="outline" className="text-[11px]">Growing</Badge>
            </div>
            <p className="mt-2 text-xl font-semibold tracking-tight">5 years 10 months</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="py-4">
            <span className="text-xs text-muted-foreground">Company</span>
            <p className="mt-2 text-xl font-semibold tracking-tight">Informatica</p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="py-4">
            <span className="text-xs text-muted-foreground">Focus</span>
            <p className="mt-2 text-xl font-semibold tracking-tight">PowerCenter, IDMC</p>
          </CardContent>
        </Card>
      </div>
