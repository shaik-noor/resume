  ...
  return (
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
        {items.map((s) => (
          <div key={s.name} className="rounded-lg border p-3 flex items-center gap-3">
            {/* Use plain img to avoid remote domain configuration */}
            <img
              src={s.image}
              alt={s.name}
...
export default function SkillsPage() {
  return (
    <section className="mx-auto max-w-5xl space-y-8">
      ...
      <SkillsGrid title="Data Integration & Orchestration" items={dataIntegrationSkills} />
